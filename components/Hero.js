    ...
    return (
        <div className="mb-5 max-w-2xl">
            ...
            <p className="mt-6 text-base text-gray-600 dark:text-gray-400">
                Currently, I'm enrolled full-time in the Cloud Computing and Blockchain program at Saskatchewan
                Polytechnic. Alongside my studies, I've been part of Autonomous Inc for almost 8 years, serving as a
                Backend Developer. Based in the US, Autonomous Inc specializes in office products.
            </p>
